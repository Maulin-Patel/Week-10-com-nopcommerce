...
public class MultiBrowserTest {
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://demo.nopcommerce.com/login?returnUrl=%2"); // Opening provided url in Chrome Browser
        ...
        driver.findElement(By.id("Email")).sendKeys("maulin1@gmail.com"); // Finding email field with id Locator and passing value to put into email field
        driver.findElement(By.id("Password")).sendKeys("12345"); // // Finding password field with id Locator and passing value to put into email field
